...
\begin{titlepage}
    ...
    {\LARGE \textbf{PILL PILOT} \\}
     {\small \textbf{(A pill remainder and organiser)} \\}
    ...
    \vspace{5mm}
    \begin{center}
        \textbf{ABHISHEK C (Reg No: MUT24CS011)}\\
        \textbf{ADIL JUNAID (Reg No: MUT24CS014)}\\
        \textbf{AIBIN JAMES BURBY (Reg No: MUT24CS016)}\\
        \textbf{ANANTHAKRISHNAN A D (Reg No: MUT24CS033)}\\
        \textbf{ANSHIN SHAJU (Reg No: MUT24CS041)}
    \end{center}
...
This is to certify that the Micro Project report entitled \textbf{ "PILL PILOT"} submitted by \textbf{"  ABHISHEK C (  Reg No: MUT24CS011),ADIL JUNAID (Reg No : MUT24CS014) ,  AIBIN JAMES BURBY (Reg No: MUT24CS016),  ANANTHAKRISHNAN A D (Reg No: MUT24CS033),ANSHIN SHAJU (Reg No: MUT24CS041)"} of Semester II is a bonafide account of the work done by them under our supervision during the academic year 2024-25.
